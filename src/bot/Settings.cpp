...
vemt::bot::Settings::Settings(const int64_t serverID, const int64_t bot_category, const int64_t bot_control_channel,
	const int64_t entry_channel, const int64_t status_channel, const int64_t exhibitor_category, const int64_t bot_admin_role,
	const int64_t exhibitor_role, const int64_t vemt_bot_role, const int64_t everyone_role)
	: server_id_(serverID), bot_category_(bot_category), bot_control_channel_(bot_control_channel),
	entry_channel_(entry_channel), status_channel_(status_channel), exhibitor_category_(exhibitor_category),
	bot_admin_role_(bot_admin_role), exhibitor_role_(exhibitor_role), vemt_bot_role_(vemt_bot_role), everyone_role_(everyone_role) {}
...
vemt::bot::Settings::Settings(const Settings & s) noexcept
	...
	entry_channel_(s.entry_channel_), status_channel_(s.status_channel_), exhibitor_category_(s.exhibitor_category_),
	bot_admin_role_(s.bot_admin_role_), exhibitor_role_(s.exhibitor_role_), vemt_bot_role_(s.vemt_bot_role_), everyone_role_(s.everyone_role_) {}
...
vemt::bot::Settings vemt::bot::Settings::createSettings(const int64_t serverID, const int64_t bot_category, const int64_t bot_control_channel, const int64_t entry_channel,
	const int64_t status_channel, const int64_t exhibitor_category, const int64_t bot_admin_role, const int64_t exhibitor_role, const int64_t vemt_bot_role, const int64_t everyone_role) {
	const std::string filename = Settings::_getFilename(serverID);
	...
	Settings settings(serverID, bot_category, bot_control_channel, entry_channel, status_channel, exhibitor_category, bot_admin_role, exhibitor_category, vemt_bot_role, everyone_role);
